...
import { Users, UserPlus, AlertCircle, Loader2, Trash2, Edit2 } from 'lucide-react';
                    ...
                    <td className="py-4 px-6">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="px-3 py-1 bg-k8s-blue/20 text-k8s-blue rounded text-sm hover:bg-k8s-blue/30 transition-colors"
                        >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="k8s-card p-6 w-full max-w-md mx-4">
            ...
            <form onSubmit={handleUpdateUser} className="space-y-4">
              {/* Username Field */}
              <div>
                <label htmlFor="edit-username" className="block text-sm font-medium text-k8s-gray mb-2">
                  Username
                </label>
                <input
                  type="text"
              ...
              {/* Email Field */}
              <div>
                <label htmlFor="edit-email" className="block text-sm font-medium text-k8s-gray mb-2">
                  Email
                </label>
                <input
                  type="email"
              ...
              {/* Role Field */}
              <div>
                <label htmlFor="edit-role" className="block text-sm font-medium text-k8s-gray mb-2">
                  Role
                </label>
                <select
                  id="edit-role"
